...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Executor.execute(() -> rebuildMatrixBySortingRowsAscendingCharacteristics(matrix),
    ...
    private static MatrixInts rebuildMatrixBySortingRowsAscendingCharacteristics(MatrixInts matrix) {
