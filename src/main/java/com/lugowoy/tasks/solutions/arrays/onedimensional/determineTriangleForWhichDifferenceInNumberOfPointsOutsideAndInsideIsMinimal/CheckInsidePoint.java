...
import com.lugowoy.helper.calculations.CalculationByThreeParameters;
...
public interface CheckInsidePoint {
    ...
    CalculationByThreeParameters<Double, Point2D<Double>, Point2D<Double>, Point2D<Double>>
            CALCULATION = (kFirst, vSecond, zThird) -> {
    ...
    int isInside(Point2D<Double> pointToCheck, Point2D<Double> firstPoint,
                 Point2D<Double> secondPoint, Point2D<Double> thirdPoint);

    static int isInsideTrianglePoints(Point2D<Double> pointToCheck,
                                      Point2D<Double> firstPoint,
                                      Point2D<Double> secondPoint,
                                      Point2D<Double> thirdPoint) {
